...
There are functions to work with the raw_img bytearray data snap7 functions return
...
def get_ulint(bytearray_: bytearray, byte_index: int) -> int:
    ...
    Examples:
        Read 8 Bytes raw_img from DB1.10, where an ulint value is stored. Return Python compatible value.
        >>> data = client.db_read(db_number=1, start=10, size=8)
...
def get_char(bytearray_: bytearray, byte_index: int) -> str:
    ...
    Examples:
        Read 1 Byte raw_img from DB1.10, where a char value is stored. Return Python compatible value.
...
def get_wchar(bytearray_: bytearray, byte_index: int) -> Union[ValueError, str]:
    ...
    Examples:
        Read 2 Bytes raw_img from DB1.10, where a wchar value is stored. Return Python compatible value.
...
def get_wstring(bytearray_: bytearray, byte_index: int) -> str:
    ...
    Examples:
        Read from DB1.10 22, where the WSTRING is stored, the raw_img 22 Bytes and convert them to a python string
