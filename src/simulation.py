...
class simulationScreen(QDialog):
    ...
    def update_param(self):
        ...
        self.param.data.ColorThreshold2.H_upper = self.tresh_2_H_upper.value()
        self.param.data.ColorThreshold2.S_upper = self.tresh_2_S_upper.value()
        self.param.data.ColorThreshold2.V_upper = self.tresh_2_V_upper.value()
